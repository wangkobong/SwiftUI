...
extension WidgetData {
    ...
    static func write(location: String?, currentWeather: CurrentWeather?, forecast: [Forecast]?) {
        ...
        let data = WidgetData(location: location, temperature: currentWeather.temperature, icon: currentWeather.icon, weather: currentWeather.weather, minTemperature: currentWeather.minTemperature, maxTemperature: currentWeather.maxTemperature, date: currentWeather.forecastDate)
        
        list.append(data)
        
        list.append(contentsOf: forecast.map { WidgetData(location: location, temperature: $0.temperature, icon: $0.icon, weather: $0.weather, minTemperature: $0.minTemperature, maxTemperature: $0.maxTemperature, date: $0.forecastedDate)})
